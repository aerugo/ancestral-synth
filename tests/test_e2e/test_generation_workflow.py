...
class MockBiographyAgent:
    ...
    async def generate(self, context) -> Biography:
        self.call_count += 1
        ...
        return Biography(content=content, word_count=len(content.split()))
...
class MockExtractionAgent:
    ...
    async def extract(self, biography: str) -> ExtractedData:
        self.call_count += 1
        return self._create_extracted_data("Test", "Person", 1950)
    ...
    async def extract_with_hints(
        ...
        return self._create_extracted_data(
